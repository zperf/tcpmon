...
func TSDBPrintTcpMetric(m *TcpMetric, hostname string) {
...
func TSDBPrintNicMetric(m *NicMetric, hostname string) {
...
func TSDBPrintNetstatMetric(m *NetstatMetric, hostname string) {
