...
func (m *TcpMetric) TSDBPrintTcpMetric(hostname string) {
...
func (m *NicMetric) TSDBPrintNicMetric(hostname string) {
...
func (m *NetstatMetric) TSDBPrintNetstatMetric(hostname string) {
